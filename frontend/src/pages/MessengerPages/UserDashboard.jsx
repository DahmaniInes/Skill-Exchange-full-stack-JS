...
const ReportTable = () => {
  ...
  const formatDate = (dateString) => {
    ...
    return date.toLocaleDateString('en-US'); // Changed to en-US for English date format
  };
  ...
  // Handle conversation analysis button click (placeholder)
  const handleConversationAnalysis = () => {
    console.log('Conversation Analysis button clicked');
    // Add functionality here if specified
  };
